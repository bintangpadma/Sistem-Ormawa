<div class="modal" id="createModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonCreateStudentActivityUnitStructure" class="form" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonEditStudentActivityUnitStructure" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-input lg:col-span-2">
                    <label>
...
<div class="modal" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="content-body">
            <form id="buttonDeleteStudentActivityUnitStructure" class="form" method="POST">
                @csrf
                @method('DELETE')
